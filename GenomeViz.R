...
dir=args[2]
mut=args[3]
#VCF=fread(paste0("/fhgfs/groups/lab_bock/jklughammer/projects/otherProjects/PGA/variant_calling_process_cohort_cohort_sample_",sample,"_parsed.vcf"))
setwd(dir)
...
#h8=Hilbert(level=8)
#h9=Hilbert(level=9)
#h10=Hilbert(level=10)
h11=Hilbert(level=11)
#h12=Hilbert(level=12)


VCF_pass[,hilb_x:=h11[,1],]
VCF_pass[,hilb_y:=h11[,2],]
levels(as.factor(VCF_pass$EFFECT))
...
#png(paste0("/fhgfs/groups/lab_bock/jklughammer/projects/otherProjects/PGA/",sample,"/",sample,"_hilb_",11-i,"_1.png"),width=800,height=800)
...
#png(paste0("/fhgfs/groups/lab_bock/jklughammer/projects/otherProjects/PGA/",sample,"/",sample,"_hilb_",11-i,"_2.png"),width=800,height=800)
